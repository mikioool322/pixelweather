          ...
          <div className="w-full flex flex-col md:hidden">
            ...
            <div className="w-full flex flex-row items-center gap-2">
              ...
              <button
                ...
                disabled={loading}
              >
                <span role="img" aria-label="search"><img src="assets/lupkaa.png" alt="search icon" /></span>
              </button>
          ...
          <div className="w-full flex flex-row items-center gap-2 hidden md:flex">
            <div className="flex flex-row items-center flex-1 min-w-0">
              ...
              <button
                ...
                disabled={loading}
              >
                <span role="img" aria-label="search"><img src="public/assets/lupkaa.png" alt="search icon" /></span>
              </button>
            </div>
            <div className="flex items-center gap-2 ml-2">
              <button
